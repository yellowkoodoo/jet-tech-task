...
export async function login(request: APIRequestContext, user: User): Promise<any> {
...
export async function logout(request: APIRequestContext, user: User): Promise<any> {
